...
import 'package:handyman/app/backend/model/appoinments_model.dart';
import 'package:handyman/app/backend/model/issuewith_model.dart';
...
class ComplaintsController extends GetxController implements GetxService {
  ...
  Future<void> getOrderDetails() async {
    ...
    if (response.statusCode == 200) {
      ...
      freelancerName =
          '${orderData.freelancerInfo!.firstName} ${orderData.freelancerInfo!.lastName}';
      _issueWithList = [];
